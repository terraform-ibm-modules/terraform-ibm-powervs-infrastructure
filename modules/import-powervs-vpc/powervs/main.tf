data "ibm_resource_instance" "power_workspace_ds" {
  name = var.pi_workspace_name
}

data "ibm_pi_images" "powervs_workspace_images_ds" {
  pi_cloud_instance_id = data.ibm_resource_instance.power_workspace_ds.guid
}

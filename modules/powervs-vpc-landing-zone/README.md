...
| [ibm_resource_instance.create_instance_monitoring](https://registry.terraform.io/providers/IBM-Cloud/ibm/latest/docs/resources/resource_instance) | resource |
...
| <a name="input_enable_monitoring"></a> [enable\_monitoring](#input\_enable\_monitoring) | Specify if SAP Monitoring will be enabled. including IBM Cloud Monitoring Instance and Intel workload VSI . Set to 'false' if you do not want any monitoring.The monitoring instance will be created in the same region. | `bool` | `true` | no |
| <a name="input_existing_monitoring_instance_crn"></a> [existing\_monitoring\_instance\_crn](#input\_existing\_monitoring\_instance\_crn) | crn of IBM Cloud Monitoring Instance. | `string` | `null` | no |
...
| <a name="input_ibm_cloud_monitoring_instance_name"></a> [ibm\_cloud\_monitoring\_instance\_name](#input\_ibm\_cloud\_monitoring\_instance\_name) | Specify the name of the IBM Cloud Monitoring Instance. | `string` | `"IBM Cloud SAP Monitoring Instance"` | no |
...
| <a name="output_existing_monitoring_instance_crn"></a> [existing\_monitoring\_instance\_crn](#output\_existing\_monitoring\_instance\_crn) | CRN of the IBM Cloud Monitoring Instance |
| <a name="output_location"></a> [location](#output\_location) | location = region  of the IBM Cloud Monitoring Instance |
| <a name="output_monitoring_instance_guid"></a> [monitoring\_instance\_guid](#output\_monitoring\_instance\_guid) | location = region  of the IBM Cloud Monitoring Instance |

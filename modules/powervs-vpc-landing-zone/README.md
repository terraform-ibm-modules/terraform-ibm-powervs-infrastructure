...
| <a name="module_landing_zone"></a> [landing\_zone](#module\_landing\_zone) | terraform-ibm-modules/landing-zone/ibm//patterns//vsi//module | 8.21.15 |
...
| <a name="module_private_secret_engine"></a> [private\_secret\_engine](#module\_private\_secret\_engine) | terraform-ibm-modules/secrets-manager-private-cert-engine/ibm | 2.0.6 |
| <a name="module_scc_wp_instance"></a> [scc\_wp\_instance](#module\_scc\_wp\_instance) | terraform-ibm-modules/scc-workload-protection/ibm | 1.22.5 |
| <a name="module_secrets_manager_group"></a> [secrets\_manager\_group](#module\_secrets\_manager\_group) | terraform-ibm-modules/secrets-manager-secret-group/ibm | 1.5.6 |
| <a name="module_secrets_manager_private_certificate"></a> [secrets\_manager\_private\_certificate](#module\_secrets\_manager\_private\_certificate) | terraform-ibm-modules/secrets-manager-private-cert/ibm | 1.12.10 |
...
| <a name="input_enable_webdispatcher"></a> [enable\_webdispatcher](#input\_enable\_webdispatcher) | Specify whether to create 2 additional Intel VSIs running SAP Web Dispatcher, fronted by an Application Load Balancer, for SAP HTTP(S) ingress. | `bool` | `false` | no |
...
| <a name="input_powervs_resource_group_name"></a> [powervs\_resource\_group\_name](#input\_powervs\_resource\_group\_name) | Existing IBM Cloud resource group name. Used for PowerVS related resources. If null, '<var.prefix>-ocp-rg' is created and used for TGW, VPC, and PowerVS resources. | `string` | n/a | yes |
...
| <a name="input_vpc_subnet_cidrs"></a> [vpc\_subnet\_cidrs](#input\_vpc\_subnet\_cidrs) | CIDR values for the VPC subnets to be created. It's customer responsibility that none of the defined networks collide, including the PowerVS subnets and VPN client pool. The 'webdispatcher' key is optional and defaults to '10.30.50.0/24'; it is only used when 'enable\_webdispatcher' is true. | <pre>object({<br/>    vpn           = string<br/>    mgmt          = string<br/>    vpe           = string<br/>    edge          = string<br/>    webdispatcher = optional(string, "10.30.50.0/24")<br/>  })</pre> | <pre>{<br/>  "edge": "10.30.40.0/24",<br/>  "mgmt": "10.30.20.0/24",<br/>  "vpe": "10.30.30.0/24",<br/>  "vpn": "10.30.10.0/24"<br/>}</pre> | no |
| <a name="input_webdispatcher_lb_type"></a> [webdispatcher\_lb\_type](#input\_webdispatcher\_lb\_type) | Whether the Web Dispatcher ALB is 'public' or 'private'. | `string` | `"public"` | no |
| <a name="input_webdispatcher_listener_port"></a> [webdispatcher\_listener\_port](#input\_webdispatcher\_listener\_port) | ALB listener port for Web Dispatcher traffic (also the backend pool member + health-check port). | `number` | `44321` | no |
| <a name="input_webdispatcher_vsi_profile"></a> [webdispatcher\_vsi\_profile](#input\_webdispatcher\_vsi\_profile) | Compute profile of the Web Dispatcher VSIs. | `string` | `"cxf-2x4"` | no |
...
| <a name="output_webdispatcher_vsi_ips"></a> [webdispatcher\_vsi\_ips](#output\_webdispatcher\_vsi\_ips) | Private IPv4 addresses of the 2 Web Dispatcher VSIs. Empty list if enable\_webdispatcher is disabled. |

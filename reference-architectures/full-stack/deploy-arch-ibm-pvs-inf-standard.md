...
![Design requirements for 'Power infrastructure for deployable architectures' - variation 'PowerVS workspace FullStack'.](heatmap.svg "Design requirements"){: caption="Figure 1. Scope of the solution requirements" caption-side="bottom"}

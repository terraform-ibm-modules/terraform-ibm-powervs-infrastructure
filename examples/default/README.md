...
| <a name="input_existing_resource_group"></a> [existing\_resource\_group](#input\_existing\_resource\_group) | An existing resource group name to use for this example, mutually exclusive with resource\_group\_name | `any` | `null` | no |
...
| <a name="input_resource_group"></a> [resource\_group](#input\_resource\_group) | A new resource group will be created, mutually exclusive with existing\_resource\_group\_name | `string` | `null` | no |

...
variable "powervs_image_names" {
  ...
  type        = list(string)
  default     = ["IBMi-75-02-2924-1", "IBMi-75-02-2984-1", "7300-01-02", "7200-05-06", "SLES15-SP5-SAP", "SLES15-SP5-SAP-NETWEAVER", "RHEL8-SP8-SAP", "RHEL8-SP8-SAP-NETWEAVER", "RHEL9-SP2-SAP", "RHEL8-SP8-SAP-NETWEAVER"]
}

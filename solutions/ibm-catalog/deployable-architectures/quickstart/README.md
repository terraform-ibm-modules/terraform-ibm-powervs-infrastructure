...
| <a name="input_powervs_instance_boot_image"></a> [powervs\_instance\_boot\_image](#input\_powervs\_instance\_boot\_image) | Override the t-shirt size specs of powervs worspace instance by selecting an image name and providing valid custom\_profile parameter. | `string` | `"RHEL8-SP4-SAP"` | no |
...
| <a name="input_tshirt_size"></a> [tshirt\_size](#input\_tshirt\_size) | PowerVS instance profiles. These profiles can be overriden by specifying powervs\_instance\_boot\_image and custom\_profile values in optional parameters. | `string` | `"sap-dev"` | no |

##############################################################################
# OpenShift Ansible Module - Simplified Wrapper
...
module "ansible_executor" {
  source = "../../../modules/ansible-executor"
  ...
  enable_playbook_encryption = var.encrypt_playbook

  # OpenShift-specific features
  enable_ocp_config_encryption = true
  enable_api_key_redaction     = var.ibmcloud_api_key != null
  ibmcloud_api_key             = var.ibmcloud_api_key
  ocp_cluster_dir              = lookup(var.playbook_template_vars, "CLUSTER_DIR", "/tmp")
}

...
locals {
  ...
  network_services_config = {
    squid = { enable = true, squid_server_ip_port = module.standard.proxy_host_or_ip_port, no_proxy_hosts = "161.0.0.0/0,${var.vpc_subnet_cidrs.vpn},${var.vpc_subnet_cidrs.mgmt},${var.vpc_subnet_cidrs.vpe},${var.vpc_subnet_cidrs.edge},${var.powervs_management_network.cidr},${var.powervs_backup_network.cidr},${var.client_to_site_vpn.client_ip_pool}" }
